...
screen_clear        ldx #$00                                     ; set X to zero (black color code)
                    ...
                    +set16im $C00, screen_back_buffer_base
...
screen_init
                    lda $D016       
                    and #%11110111 ; Enable 38-column mode
                    ora #%00010000 ; Activate character multicolor mode
                    sta $D016

                    ; lda $D018       ; Set the character set address to $1000
                    ; and #%11110000
                    ; ora #%00000100
                    ; sta $D018
                    lda $D018
...
screen_shift_lower                                               ; copy the lower half of screen to back buffer
                    ...
                    ldx #ROWS_PER_COPY+1                           ; x is the nbr of rows to copy
...
color_shift_lower
                    ...
                    ldy #0                                       ; y is the current column
                    ldx #ROWS_PER_COPY+1                           ; nbr of rows to copy
                    jmp video_ram_copy_line