...
BEGIN_VBLANK_LINE = 255
SYSTEM_IRQ_HANDLER = $ea81


; vars
xscroll             !byte 7                                      ; Pixel shift of current hardware scroll
xpan                !byte 39                                     ; Shift of screen in chars
xpage               !byte 0                                      ; Number of full screens shifted
